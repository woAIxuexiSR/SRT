...
//             L = rayInfo.mat->Emission();
//         else if (!rayInfo.isHit)
//             L = launchParams.background;
//         else
//         {
...
//                     float pw = ls.pdf * dist * dist / cosine;
//                     L = rayInfo.mat->Eval(lightRay.dir, -ray.dir, rayInfo.hitNormal, rayInfo.color) * dot(lightRay.dir, rayInfo.hitNormal) * ls.emission / pw;
//                 }
//             }
//             else
//             {
...
//                 float cosine = abs(dot(ms.wi, rayInfo.hitNormal));
...
//                 );
//                 if (rayInfo.isHit && rayInfo.mat->isLight())
//                     L = rayInfo.mat->Emission() * ms.f * cosine / ms.pdf;
//                 else if (!rayInfo.isHit)
//                     L = launchParams.background * ms.f * cosine / ms.pdf;
//             }
//         }
//         result += L;
//     }
